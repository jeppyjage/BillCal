...
const s = StyleSheet.create({
  root: { flex: 1 },
  header: {
    paddingHorizontal: SPACING.lg, paddingTop: 4, paddingBottom: 6,
    flexDirection: "row", alignItems: "center", gap: SPACING.md,
  },
  todayBtn: { flexDirection: "row", alignItems: "center", gap: 6, paddingHorizontal: 12, paddingVertical: 6, borderRadius: 10, borderWidth: 1, minHeight: 30 },
